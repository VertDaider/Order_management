...
import com.serious.exception.NoSuchOrderInfoException;
import com.serious.model.OrderInfo;
import com.serious.model.impl.OrderInfoImpl;
import com.serious.model.impl.OrderInfoModelImpl;
...
public class OrderInfoPersistenceImpl
	...
	public OrderInfo updateImpl(OrderInfo orderInfo) {
		...
		entityCache.putResult(OrderInfoImpl.class, orderInfo, false, true);
