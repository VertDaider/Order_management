...
/**
 * The persistence utility for the orders service. This utility wraps <code>com.serious.service.persistence.impl.OrdersPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class OrdersUtil {
	 ...
	 */
	public static Map<Serializable, Orders> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Orders> findWithDynamicQuery(
	...
	public static List<Orders> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<Orders> orderByComparator) {
	 ...
	 */
	public static void cacheResult(Orders orders) {
	 ...
	 */
	public static void cacheResult(List<Orders> orderses) {
	 ...
	 */
	public static Orders create(long id) {
	 ...
	 */
	public static Orders remove(long id)
		throws com.serious.exception.NoSuchOrdersException {

		return getPersistence().remove(id);
	}

	public static Orders updateImpl(Orders orders) {
	 ...
	 * @throws NoSuchOrdersException if a orders with the primary key could not be found
	 */
	public static Orders findByPrimaryKey(long id)
		throws com.serious.exception.NoSuchOrdersException {
	 ...
	 */
	public static Orders fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<Orders> findAll(int start, int end) {
	...
	private static ServiceTracker<OrdersPersistence, OrdersPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(OrdersPersistence.class);

		ServiceTracker<OrdersPersistence, OrdersPersistence> serviceTracker =
			new ServiceTracker<OrdersPersistence, OrdersPersistence>(
				bundle.getBundleContext(), OrdersPersistence.class, null);
