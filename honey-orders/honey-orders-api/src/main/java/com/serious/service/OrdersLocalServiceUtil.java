 ...
 * <code>com.serious.service.impl.OrdersLocalServiceImpl</code> and
...
public class OrdersLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.serious.service.impl.OrdersLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Orders createOrders(long id) {
		return getService().createOrders(id);
	}
	 ...
	 */
	public static Orders deleteOrders(long id) throws PortalException {
		return getService().deleteOrders(id);
	}
	 ...
	 * @return the orders that was removed
	 */
	public static Orders deleteOrders(Orders orders) {
	...
	public static Orders fetchOrders(long id) {
		return getService().fetchOrders(id);
	}
	 ...
	 * @throws PortalException if a orders with the primary key could not be found
	 */
	public static Orders getOrders(long id) throws PortalException {
		return getService().getOrders(id);
	}
	 ...
	 */
	public static List<Orders> getOrderses(int start, int end) {
	...
	private static volatile OrdersLocalService _service;
