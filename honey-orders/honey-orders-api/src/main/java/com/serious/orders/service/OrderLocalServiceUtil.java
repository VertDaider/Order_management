 ...
 * <code>com.serious.orders.service.impl.OrderLocalServiceImpl</code> and
...
public class OrderLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.serious.orders.service.impl.OrderLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Order createOrder(long id) {
		return getService().createOrder(id);
	}
	 ...
	 */
	public static Order deleteOrder(long id) throws PortalException {
		return getService().deleteOrder(id);
	}
	...
	public static Order fetchOrder(long id) {
		return getService().fetchOrder(id);
	}
	 ...
	 * @throws PortalException if a order with the primary key could not be found
	 */
	public static Order getOrder(long id) throws PortalException {
		return getService().getOrder(id);
	}
	 ...
	 */
	public static List<Order> getOrders(int start, int end) {
	...
	private static volatile OrderLocalService _service;
